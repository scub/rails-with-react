...
function AuthMenu() {
  ...
  return (
    <div className='position-relative'>
      <button
        type='button'
        className='icon-btn btn btn-outline-light btn-sm'
        aria-label='Menu'
      ...
      {menuOpen && (
        <div className='dropdown-menu show position-absolute end-0 mt-1'>
          {authenticated ? (
            ...
            <button type='button' className='dropdown-item' onClick={() => openModal('login')}>
              Log in
            </button>
          )}
        </div>
              ...
              <div className='modal-content'>
                ...
                <div className='modal-body'>
                  <form onSubmit={handleSubmit}>
                    ...
                    {mode === 'signup' && (
                      <div className='mb-3'>
                        <label className='form-label' htmlFor='auth-password-confirmation'>
                          Confirm password
                        </label>
                        <input
